...
class stnewsportal_front_page_main_news_area extends WP_Widget {

	function __construct() {
		$widget_ops  = array(
			'classname'   => 'widget_featured_slider widget_featured_meta',
			'description' => __( 'Display latest posts or posts of specific category, which will be used as the slider.', 'stnewsportal' ),
		);
		$control_ops = array( 'width' => 200, 'height' => 250 );
		parent::__construct( false, $name = __( 'Featured Category Slider', 'stnewsportal' ), $widget_ops );
	}
...
<?php
	...
	function widget( $args, $instance ) {
		...
		echo $before_widget;
		?>
<?php $featured = 'stnewsportal-featured-image'; ?>
        ...
        <div class="slide-content">
            ...
            <div class="below-entry-meta">
                ...
                <span class="comments"><i
                        class="fa fa-comment"></i><?php comments_popup_link( '0', '1', '%' ); ?></span>
            </div>
        </div>
