...
class stnewsportal_featured_posts_vertical_widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct( false, $name = __( 'TG: Featured Posts (Style 2)', 'stnewsportal' ), $widget_ops );
	}
	...
	function form( $instance ) {
		...
		?>
<p><?php _e( 'Layout will be as below:', 'stnewsportal' ) ?></p>
...
<?php
		if ( $type != 'latest' ) {
			$border_color = 'style="border-bottom-color:' . stnewsportal_category_color( $category ) . ';"';
			$title_color  = 'style="background-color:' . stnewsportal_category_color( $category ) . ';"';
		} else {
			$border_color = '';
			$title_color  = '';
		}
...
<?php
		...
		while ( $get_featured_posts->have_posts() ):$get_featured_posts->the_post();
			?>
<?php if ( $i == 1 ) {
				$featured = 'stnewsportal-featured-post-medium';
			} else {
				$featured = 'stnewsportal-featured-post-small';
			} ?>
<?php if ( $i == 1 ) {
...
<div class="single-article clearfix">
    ...
    <div class="article-content">
        <?php //stnewsportal_colored_category(); ?>
