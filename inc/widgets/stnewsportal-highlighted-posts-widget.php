...
class stnewsportal_highlighted_posts_widget extends WP_Widget {

	function __construct() {
		$widget_ops  = array(
			'classname'                   => 'widget_highlighted_posts widget_featured_meta',
			'description'                 => __( 'Display latest posts or posts of specific category. Suitable for the Area Beside Slider Sidebar.', 'stnewsportal' ),
			'customize_selective_refresh' => true,
		);
		$control_ops = array( 'width' => 200, 'height' => 250 );
		parent::__construct( false, $name = __( 'TG: Highlighted Posts', 'stnewsportal' ), $widget_ops );
	}
    ...
    <div class="single-article">
        <?php
					if ( has_post_thumbnail() ) {
						...
						$image .= '<figure class="highlights-featured-image img-fluid">';
