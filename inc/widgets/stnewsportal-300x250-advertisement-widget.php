...
class stnewsportal_300x250_advertisement_widget extends WP_Widget {

	function __construct() {
		$widget_ops  = array(
			'classname'                   => 'widget_300x250_advertisement',
			'description'                 => __( 'Add your 300x250 Advertisement here', 'stnewsportal' ),
			'customize_selective_refresh' => true,
		);
		$control_ops = array( 'width' => 200, 'height' => 250 );
		parent::__construct( false, $name = __( 'TG: 300x250 Advertisement', 'stnewsportal' ), $widget_ops );
	}
...
<label><?php _e( 'Add your Advertisement 300x250 Images Here', 'stnewsportal' ); ?></label>
<p>
