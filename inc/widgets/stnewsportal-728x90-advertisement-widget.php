...
class stnewsportal_728x90_advertisement_widget extends WP_Widget {

	function __construct() {
		$widget_ops  = array(
			'classname'                   => 'widget_728x90_advertisement',
			'description'                 => __( 'Add your 728x90 Advertisement here', 'stnewsportal' ),
			'customize_selective_refresh' => true,
		);
		$control_ops = array( 'width' => 200, 'height' => 250 );
		parent::__construct( false, $name = __( 'TG: 728x90 Advertisement', 'stnewsportal' ), $widget_ops );
	}
...
<label><?php _e( 'Add your Advertisement 728x90 Images Here', 'stnewsportal' ); ?></label>
<p>
    <label for="<?php echo $this->get_field_id( $image_link ); ?>">
        <?php _e( 'Advertisement Image Link ', 'stnewsportal' ); ?></label>
...
<p>
    <label for="<?php echo $this->get_field_id( $image_url ); ?>">
        <?php _e( 'Advertisement Image ', 'stnewsportal' ); ?></label>
    ...
    <?php
			...
			if ( ! empty( $image_url ) ) {
				...
				if ( ! empty( $image_link ) ) {
					...
					$output .= '<img src="' . $image_url . '" width="728" height="90" alt="' . $image_alt . '" class="img-fluid">';
				}
				$output .= '</div>';
				echo $output;
			}
